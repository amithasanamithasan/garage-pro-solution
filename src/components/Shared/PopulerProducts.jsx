...
const PopulerProducts = () => {
    const products = [
        { id: 1, name: "Car Engine Plug", price: "$100.00", image: "/assets/7.png" },
        { id: 2, name: "Car Air Filter", price: "$120.00", image: "/assets/8.png" },
        { id: 3, name: "Cools Led Light", price: "$130.00", image: "/assets/9.png" },
        { id: 4, name: "Cools Led Light", price: "$20.00", image: "/assets/10.png" },
        { id: 5, name: "Cools Led Light", price: "$20.00", image: "/assets/11.png" },
        { id: 6, name: "Cools Led Light", price: "$20.00", image: "/assets/12.png" },
      ];
    return (
                    ...
                    <div key={product.id} className="bg-white border rounded-lg shadow-sm overflow-hidden hover:shadow-lg transition-shadow duration-200">
                        <div className="flex justify-center items-center bg-gray-100 p-6">
                            <Image 
                                src={product.image} 
                                alt={product.name} 
                                width={150} // Adjust for your preferred width
                                height={150} // Adjust for your preferred height
